...
..\executable\wget -N --no-check-certificate https://raw.githubusercontent.com/osmandapp/OsmAnd-resources/master/obf_creation/rendering_types.xml

mkdir output
mkdir temp
mkdir input

rem copy ..\UA.osm.pbf input\Ukraine.osm.pbf
...
java.exe -Djava.util.logging.config.file=logging.properties -Xms256M -Xmx6G -cp "./OsmAndMapCreator/OsmAndMapCreator.jar;./OsmAndMapCreator/lib/OsmAnd-core.jar;./OsmAndMapCreator/lib/*.jar" net.osmand.data.index.IndexBatchCreator ./cfg/batch.xml 
